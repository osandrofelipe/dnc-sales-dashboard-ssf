...
function Profile() {
    ...
    const handleDelete = async () => {
        if (confirm ('Tem certeza que deseja excluir sua conta? Se sim, certifique-se de deletar o seu leads antes.')) {
            try {
                ...
                <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr' }, gap: 4 }}>
                    ...
                    <Box>
                        <CardComponent>
                            ...
                            <StyledButton id="logout" className="alert" onClick={logout}> Logout </StyledButton>
                        </CardComponent>
                    </Box>
                </Box>
            </Container>
